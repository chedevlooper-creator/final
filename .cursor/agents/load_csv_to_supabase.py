...
def generate_sql_insert(row_data):
    """SQL INSERT statement'ı oluşturur"""
    # NULL değerleri için özel işleme
    def sql_value(val):
    ...
    if row_data.get('nationality_id'):
        fields.append('nationality_id')
        values.append(sql_value(row_data['nationality_id']))
    
    if row_data.get('country_id'):
        fields.append('country_id')
        values.append(sql_value(row_data['country_id']))
    
    if row_data.get('city_id'):
        fields.append('city_id')
        values.append(sql_value(row_data['city_id']))
    
    if row_data.get('district_id'):
        fields.append('district_id')
        values.append(sql_value(row_data['district_id']))
    
    if row_data.get('neighborhood_id'):
        fields.append('neighborhood_id')
        values.append(sql_value(row_data['neighborhood_id']))
    ...
    if row_data.get('category_id'):
        ...
        values.append(sql_value(row_data['category_id']))
    
    if row_data.get('partner_id'):
        fields.append('partner_id')
        values.append(sql_value(row_data['partner_id']))
