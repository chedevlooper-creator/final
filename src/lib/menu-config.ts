...
export const menuItems: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Tüm Yardımlar", href: "/dashboard/aids", icon: HandHeart },
      {
        ...
        href: "/dashboard/aids/cashdesk",
        icon: Banknote,
      },
      {
        title: "Banka Ödeme Emirleri",
        href: "/dashboard/aids/transfer",
        icon: CreditCard,
      },
      {
        title: "Nakdi Yardım İşlemleri",
        href: "/dashboard/aids/cash",
        icon: DollarSign,
      },
      {
        title: "Ayni Yardım İşlemleri",
        href: "/dashboard/aids/logistics",
        icon: Gift,
      },
      {
        title: "Hizmet Sevk",
        href: "/dashboard/aids/service",
        icon: UserCheck,
      },
  ...
  },
  {
    ...
    items: [
      { title: "Gönüllüler", href: "/dashboard/volunteers", icon: UserCheck },
      {
        ...
        href: "/dashboard/volunteers/missions",
        icon: Calendar,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        title: "Satın Alma Taleplerleri",
        href: "/dashboard/purchase",
        icon: ShoppingCart,
      },
      {
        title: "Cari Hesaplar",
        href: "/dashboard/purchase/merchants",
        icon: Users,
      },
    ],
  },
