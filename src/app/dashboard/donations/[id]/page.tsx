                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            <h1 className="text-2xl font-bold">Bağış #{donation.donation_number}</h1>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <Input type="number" value={donation.amount} className="flex-1" />
                        ...
                        <div>
                            ...
                            <Input value={donation.receipt_number || ''} placeholder="Makbuz numarası" />
                        </div>
                        <div>
