...
import { GraduationCap, Plus, Search, MoreHorizontal, Eye, Pencil, UserPlus } from 'lucide-react'
  ...
  const columns: ColumnDef<Orphan>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <span className="text-sm">{typeConfig?.label || row.original.type}</span>
      },
    },
    {
      accessorKey: 'country',
