                  ...
                  <TableRow key={consent.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        {
                          CONSENT_TYPE_OPTIONS.find(
                            (t) => t.value === consent.consent_type,
                          )?.label
                        }
                      </div>
                    </TableCell>
                    ...
                    <TableCell>
                      {consent.given_date &&
                        format(new Date(consent.given_date), "dd.MM.yyyy", {
                          locale: tr,
                        })}
                    </TableCell>
                    <TableCell>
                      {consent.expiry_date
                        ? format(new Date(consent.expiry_date), "dd.MM.yyyy", {
                            locale: tr,
                          })
                        : "Süresiz"}
                    </TableCell>
                    <TableCell>
                      {
                        SIGNATURE_TYPE_OPTIONS.find(
                          (s) => s.value === consent.signature_type,
                        )?.label
                      }
                    </TableCell>
                    <TableCell>
          ...
          <div className="space-y-4 py-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setFormData({ ...formData, consent_type: v as ConsentType })
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, consent_name: e.target.value })
                }
              />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, given_date: e.target.value })
                  }
                />
              </div>
              <div>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setFormData({
                    ...formData,
                    signature_type: v as SignatureType,
                  })
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, witness_name: e.target.value })
                }
                placeholder="Şahit adı soyadı"
              />
            </div>
            <div>
