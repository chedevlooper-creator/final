            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormData({ ...formData, session_type: v as SessionType })
                  }
                >
                  <SelectTrigger>
