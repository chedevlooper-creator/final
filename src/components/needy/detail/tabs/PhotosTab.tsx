        ...
        {photos.length === 0 ? (
          <div className="border-2 border-dashed rounded-lg p-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Henüz fotoğraf yüklenmemiş. Fotoğraf yüklemek için aşağıdaki
              butonu kullanın.
            </p>
            ...
            {photos.map((photo) => (
              ...
              >
                ...
                <div className="absolute bottom-2 left-2 bg-black/60 text-white px-2 py-1 rounded text-xs">
                  {
                    PHOTO_TYPE_OPTIONS.find((t) => t.value === photo.photo_type)
                      ?.label
                  }
                </div>
          ...
          <div className="space-y-4 py-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setFormData({ ...formData, photo_type: v as PhotoType })
                }
              >
                <SelectTrigger>
                  <SelectValue />
