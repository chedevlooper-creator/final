...
import { DollarSign, Stethoscope, Tags, AlertTriangle } from "lucide-react";
...
export const TAGS = [
  ...
  {
    id: "regular_aid",
    label: "Düzenli Yardım Yapılabilir",
    color: "text-green-600",
  },
  {
    id: "reject_future",
    label: "Gelecekteki Başvuruları Reddedilmeli",
    color: "text-red-600",
  },
  { id: "negative", label: "Olumsuz", color: "text-orange-600" },
  {
    id: "fake_document",
    label: "Sahte Evrak Getirdi / Yalan Beyanda Bulundu",
    color: "text-red-700",
  },
];
