...
import { uploadFile, deleteFile, validateFileSize, validateFileType } from '@/lib/upload'
...
export function PhotoSection({ 
  ...
  const handleFileChange = useCallback(async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Dosya geçersiz'
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Yükleme hatası'
      setError(errorMessage)
