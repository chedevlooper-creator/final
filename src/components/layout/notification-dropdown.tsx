  ...
  const content = (
    <div
      className={cn(
        ...
        isUnread ? 'bg-info/5 hover:bg-info/10' : 'hover:bg-muted'
      )}
      onClick={handleClick}
    >
        ...
        <Button variant="ghost" size="icon" className="relative">
          ...
          {hasUnread && (
            <span className="absolute -top-0.5 -right-0.5 flex h-4 w-4 items-center justify-center">
              ...
              <span className="relative inline-flex h-3 w-3 items-center justify-center rounded-full bg-danger text-[10px] text-white font-bold">
