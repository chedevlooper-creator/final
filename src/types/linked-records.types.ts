...
export type OrphanRelationType = 'guardian' | 'caretaker' | 'relative' | 'foster_parent'

export const ORPHAN_RELATION_TYPE_OPTIONS: { value: OrphanRelationType; label: string }[] = [
...
export type DependentRelationType = 'child' | 'spouse' | 'parent' | 'sibling' | 'grandparent' | 'grandchild' | 'other'

export const DEPENDENT_RELATION_TYPE_OPTIONS: { value: DependentRelationType; label: string }[] = [
...
export type SponsorType = 'individual' | 'organization' | 'foundation' | 'company'
export type SponsorshipType = 'orphan' | 'education' | 'health' | 'general' | 'food' | 'housing'
...
export const SPONSORSHIP_TYPE_OPTIONS: { value: SponsorshipType; label: string }[] = [
...
export type ReferenceType = 'personal' | 'work' | 'family' | 'neighbor' | 'religious' | 'other'
...
export type InterviewType = 'face_to_face' | 'phone' | 'video' | 'home_visit' | 'office'
export type InterviewOutcome = 'positive' | 'negative' | 'pending' | 'follow_up_needed'
...
export type SessionType = 'initial' | 'follow_up' | 'assessment' | 'counseling' | 'evaluation'
...
export type AidType = 'cash' | 'food' | 'in_kind' | 'service' | 'education' | 'health' | 'housing' | 'clothing'
export type DeliveryMethod = 'direct' | 'bank_transfer' | 'cargo' | 'hand_delivery' | 'pickup'
...
export type ConsentType = 'kvkk' | 'photo' | 'aid' | 'data_sharing' | 'marketing' | 'medical'
...
export type SocialCardType = 'green_card' | 'poverty_card' | 'refugee_card' | 'disability_card' | 'elderly_card' | 'other'
export type SocialCardStatus = 'active' | 'expired' | 'cancelled' | 'pending'

export const SOCIAL_CARD_TYPE_OPTIONS: { value: SocialCardType; label: string }[] = [
...
export const SOCIAL_CARD_STATUS_OPTIONS: { value: SocialCardStatus; label: string }[] = [
  { value: 'active', label: 'Aktif' },
...
export const LINKED_RECORD_TABS: LinkedRecordTab[] = [
  { id: 'bank_accounts', name: 'Banka Hesapları', icon: 'CreditCard', hashPath: 'iban' },
  { id: 'documents', name: 'Dokümanlar', icon: 'FileText', hashPath: 'document' },
  { id: 'photos', name: 'Fotoğraflar', icon: 'Image', hashPath: 'photo' },
  { id: 'orphan_relations', name: 'Baktığı Yetimler', icon: 'Baby', hashPath: 'orphan' },
  { id: 'dependents', name: 'Baktığı Kişiler', icon: 'Users', hashPath: 'dependent' },
  { id: 'sponsors', name: 'Sponsorlar', icon: 'Heart', hashPath: 'sponsor' },
  { id: 'references', name: 'Referanslar', icon: 'UserCheck', hashPath: 'reference' },
  { id: 'interviews', name: 'Görüşme Kayıtları', icon: 'MessageSquare', hashPath: 'interview' },
  { id: 'applications', name: 'Yardım Talepleri', icon: 'ClipboardList', badgeKey: 'pending_applications', hashPath: 'application' },
  { id: 'aids_received', name: 'Yapılan Yardımlar', icon: 'Gift', hashPath: 'relief' },
  { id: 'consents', name: 'Rıza Beyanları', icon: 'FileCheck', hashPath: 'consent' },
  { id: 'social_cards', name: 'Sosyal Kartlar', icon: 'Wallet', hashPath: 'card' },
]
