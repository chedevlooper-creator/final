-- Fix auth/RLS issues, users table/view schema, and add purchase_requests table
...
-- ============================================================
-- 2. Create purchase_requests table (missing)
-- ============================================================
...
-- ============================================================
-- 3. Fix RLS policies blocking inserts for core tables
-- ============================================================
DO $$
DECLARE
  t text;
