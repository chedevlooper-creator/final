      ...
      <div className="max-w-2xl mx-auto pt-20">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-red-200">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={reset}
              className="w-full px-6 py-3 bg-destructive hover:bg-destructive/90 text-destructive-foreground rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
            >
            ...
            <Link
              href="/support"
              className="block text-center text-info hover:text-info/80 font-medium"
            >
