...
/**
 * Olaylar (Events) Modülü - Error Sayfası
 *
 * @version 2.0.0
 * @since 2026-01-18
 */
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-purple-200">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link href="/dashboard/events" className="px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-semibold transition-colors text-center">
                Etkinlik Listesi
              </Link>
