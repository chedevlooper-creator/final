...
import { CreditCard, Plus, MoreHorizontal, Eye, Pencil, Trash2, X } from 'lucide-react'
        ...
        {!isLoading && data?.data?.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center animate-fade-in">
            ...
            <p className="text-sm text-muted-foreground">
              {hasActiveFilters ? 'Filtre kriterlerinize uygun işlem bulunamadı.' : 'Henüz banka işlemi oluşturulmadı.'}
            </p>
          </div>
        )}
      </div>
